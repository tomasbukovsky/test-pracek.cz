...
<head>
    ...
    <link rel="amphtml" href="/<?echo $nadrazenyAdresar;?>/amp/">
            ...
            if ($_POST['fullform'] == 1)
            {
                ...
                else
                {
                    $mail_text="<html><body>".$content['slevovykod_mail_part1']."
                                                <a href='http://www.anrdoezrs.net/links/".$aff_id."/type/dlg/sid/mail-voucher/http://www.datart.sk/'><big><strong>www.datart.sk</big></strong></a> ".$content['slevovykod_mail_part2']."
                                        <ul>
