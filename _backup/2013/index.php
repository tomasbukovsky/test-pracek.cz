...
<br />
<p><big><big>Přejděte na aktuální <a class="red-link" href="http://www.test-pracek.cz/2014/">Test praček 2014</a>.</big></big></p>
</div>
                    ...
                    if ($lang == "cs") 
                      {
                       ...
                       {
                         echo "<a title ='".$content['a_title']." ".$zaznam['name']."' class='nazev-pneu' href='".$zaznam['url'].$sid."' onclick=\"recordOutboundLink(this, 'Outbound Links', 'Label ".$counter."');return false;\">";
                       } 
                      }
                      elseif ($lang == "sk")
                      {
                  ...
                  echo "<td>";
                    if ($lang == "cs") 
                      { 
                       ...
                       {
                        echo "<a href='".$zaznam['url'].$sid."' onclick=\"recordOutboundLink(this, 'Outbound Links', 'Link ".$counter."');return false;\"><strong>".$content['vice-informaci']."</strong></a>";
                       } 
                      }
                      elseif ($lang == "sk")
                      {
