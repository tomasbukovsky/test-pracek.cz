...
{
    $tablename_content = "content_2017";
}
else
{
    $tablename_content = "content_".$zaznam_weby['lang']."_2017";
}
...
<head>
    ...
    <title><? echo $content['provozovatel'];?></title>
</head>
...
<div id="main">
    <div class='content'>
        ...
        <h1><? echo $content['provozovatel'];?></h1>
        <? echo $content['provozovatel_text'];?>
        <br />
        <br />
        <br />
        <br />
